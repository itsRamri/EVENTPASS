                  ...
                  <div 
                    ...
                    style={{
                      ...
                      boxShadow: avatarPreview 
                        ? '6px 6px 14px #cad3e2, -6px -6px 14px #ffffff' 
                        : 'inset 4px 4px 8px #cad3e2, inset -4px -4px 8px #ffffff',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      margin: '0 auto',
                  ...
                  >
                    {avatarPreview ? (
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', color: '#64748B' }}>
                        ...
                        <span style={{ fontSize: '0.62rem', fontWeight: 800, marginTop: 3, textTransform: 'uppercase', color: '#475569' }}>
                          Add Photo
                        </span>
                      </div>
                    )}
