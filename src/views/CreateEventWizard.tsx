              ...
              >
                <div 
                  style={{ 
                    ...
                    borderRadius: '50%', 
                    background: isActive ? 'var(--accent-primary)' : isDone ? 'var(--status-approved)' : '#F1F5F9', 
                    color: isActive || isDone ? '#FFFFFF' : '#475569', 
                    border: isActive ? '2px solid var(--accent-primary)' : isDone ? '2px solid var(--status-approved)' : '2px solid #CBD5E1',
